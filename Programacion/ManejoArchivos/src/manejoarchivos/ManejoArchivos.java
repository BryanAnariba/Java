...
public class ManejoArchivos {
    ...
    public static void escribirArchivo( String nombreArchivo, String contenido ) {
        ...
        try {
            ...
            salida.close(); 
            System.out.println("Se ha Insertado informacion el archivo exitosamente");
        } catch ( FileNotFoundException ex ) {
            System.out.println("Error archivo no encontrado: " + ex.getMessage());
        } catch ( Exception ex ) {
            System.out.println("Error: " + ex.getMessage());
    ...
    public static void anexarInformacionArchivo ( String nombreArchivo, String contenido ) {
        ...
        try {
            ...
            salida.println( contenido );
            salida.close(); 
            System.out.println("Se ha Anexado informacion el archivo exitosamente");
        } catch ( FileNotFoundException ex ) {
            System.out.println("Error archivo no encontrado: " + ex.getMessage());
    ...
    public static void leyendoArchivo ( String nombreArchivo ) {
        File archivo = new File( nombreArchivo );
        try {
