...
@Repository
public class DataGenerator2Repository implements BaseDataGenerator {

    @Override
    public List<ReportData> generateFakeData() {
        return List.of(
            new ReportData("Vegeta Super Saiyan 1", 1.0),
            new ReportData("vegeta Super Saiyan 2", 2.0),
            new ReportData("Goku Super Saiyan 3", 3.0),
            new ReportData("Trunks Super Saiyan 2", 2.0)
        );
    }
